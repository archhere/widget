  ...
  _createClass(AutoComplete, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement("input", { className: "inputclass", type: "text", value: this.state.inputVal, onChange: this.updateChange }),
        _react2.default.createElement(
          "ul",
          null,
          this.props.names.map(function (el, index) {
            return el.toLowerCase().startsWith(_this2.state.inputVal.toLowerCase()) ? _react2.default.createElement(
              "li",
              { key: index, onClick: _this2.changeValue },
              el
            ) : "";
          })
        )
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              "span",
              null,
              this.state.time.toLocaleString().slice(10),
              " PDT"
            )
          ),
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              " ",
              this.state.time.toLocaleString().slice(0, 9)
            )
          )
        )
      );
  ...
  _createClass(Tabs, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        "div",
        { className: "my-tabs" },
        this.props.panes.map(function (el, index) {
          if (index === _this2.state.index) {
            return _react2.default.createElement(
              "div",
              { key: index, className: "selected" },
              _react2.default.createElement(
                "h3",
                { onClick: function onClick() {
                    return _this2.myIndex(index);
                  } },
                el.title
              ),
              _react2.default.createElement(
            ...
            return _react2.default.createElement(
              "div",
              { key: index, className: "unselected" },
              _react2.default.createElement(
                "h3",
                { onClick: function onClick() {
                    return _this2.myIndex(index);
...
var APIKEY = "970e69ddc042bb547239631d5b86c0a5";
...
var Weather = function (_React$Component) {
  ...
  function Weather(props) {
    ...
    _this.state = { city: "who knows", temperature: "0", conditions: "nothing" };
    return _this;
  }
  ...
  _createClass(Weather, [{
    ...
    value: function componentDidMount() {
      ...
      navigator.geolocation.getCurrentPosition(function (position) {
        _this2.getLocation(position.coords.latitude, position.coords.longitude);
      });
    }
  }, {
    key: "getLocation",
    value: function getLocation(lat, lon) {
      var _this3 = this;
      ...
      xhr.onreadystatechange = function () {
        if (xhr.readyState === XMLHttpRequest.DONE && xhr.status === 200) {
          _this3.setState({ city: JSON.parse(xhr.responseText).name });
          _this3.setState({ temperature: JSON.parse(xhr.responseText).main.temp });
          _this3.setState({ conditions: JSON.parse(xhr.responseText).weather[0].description });
        } else {
          _this3.setState({ city: "Unable to locate" });
        }
      };
...
var TabViews = [{ title: "One", content: "I love Rishabh" }, { title: "Two", content: "I love Babi" }, { title: "Three", content: "I love Praveen" }];

var names = ["Harry Potter", "Hermione Granger", "Ron Weasley", "Ginny Weasly", "Loona Lovegood", "Neville Longbottom", "Draco Malfoy", "Sirius Black", "Remus Lupin", "Dedallus Diddle", "Albus Dumbledore", "Lily Potter", "Minerva McGonagal"];
...
function Root() {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(_tabs2.default, { panes: TabViews }),
